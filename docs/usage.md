...
[![img.1png](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/raw/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img1.png)](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img1.png)必填项填写后，点击 下一步 [![img.2png](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img1.png)] [![img.3png](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img1.png)] 创建直接计划后，点击 确定 [![img.4png](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img4.png)] [![img5.png](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img5.png)] 点击部署，执行计划 [![img6.png](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img6.png)] 如下图“Apply required resource success. ”即为资源创建完成 [![img7.png](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/images/img7.png)
# 3.2ECS 控制台配置
