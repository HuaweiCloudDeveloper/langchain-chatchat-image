...
>
> - VPC 您可以自行创建
> - 安全组选择 [**准备工作**](https://github.com/HuaweiCloudDeveloper/langchain-chatchat-image/blob/Langchain-Chatchat-0.3.1.3-kunpeng/docs/usage.md#准备工作) 中配置的安全组；
...
3.修改模型配置文件启动Langchain-Chatchat
